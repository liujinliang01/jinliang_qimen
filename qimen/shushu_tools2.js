function get_dayun_zibai_ruzhong(y){ // given any year, get the dayun zibai ruzhong
	var d = cycle(y-4,180)
	d = floor(d/60)
	if(d==3){
		d=0
...
function get_liuqin(wo, ta){
	...
	var wo_yinyang = wo[1]
	var ta_yinyang = ta[1]
//alert("我五行="+wo_wuxing+" 他五行=" + ta_wuxing)
